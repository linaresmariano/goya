  ...
  var Semester = sequelize.define('Semester', {
    ...
    classMethods: {
      associate: function(models) {
        ...
        Semester.hasMany(models.SemesterClassRoom, {
          as: 'SemesterClassRooms'
        });
        Semester.hasMany(models.SemesterTeacher, {
          as: 'SemesterTeachers'
        });
      },
      ...
      findByYearAndSemesterIncludingAll: function(year, semester) {
        return Semester.find({
          ...
          include: [{
            model: Semester.models.Course,
            as: 'Courses',
            require: false,
            include: [{
                model: Semester.models.CourseSchedule,
                as: 'schedules',
                require: false,
                include: [{
                  model: Semester.models.Course,
                  ...
                  model: Semester.models.SemesterClassRoom,
                  as: 'SemesterClassRoom',
                  require: false,
                  include: [{
                    model: Semester.models.ClassRoom,
                    as: 'ClassRoom',
                    require: false
                  }]
                }, {
                  model: Semester.models.SemesterTeacher,
                  as: 'SemesterTeachers',
                  require: false,
                  include: [{
                    model: Semester.models.Teacher,
                    as: 'Teacher',
                    require: false
                  }]
                }, {
                  model: Semester.models.PatchSchedule,
                  as: 'Patch',
                  require: false,
                  include: [{
                    model: Semester.models.Teacher,
