...
module.exports = function(sequelize, DataTypes) {
  ...
  var Subject = sequelize.define('Subject', {
    area: {type:DataTypes.INTEGER ,  validate: {min:0,notNull:true}},
    core: {type:DataTypes.INTEGER ,  validate: {min:0,notNull:true}},
    ...
    credits: {type:DataTypes.INTEGER ,  validate: {min:0}},
